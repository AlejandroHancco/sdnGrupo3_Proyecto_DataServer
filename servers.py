...
def server_9000():
    app = Flask("server_9000")

    @app.route('/')
    def home():
        return "Servidor en puerto 9000"

    app.run(host='0.0.0.0', port=9000)

# ---------- Módulo del servidor en puerto 9001 ----------
def server_9001():
    app = Flask("server_9001")

    @app.route('/')
    def home():
        return "Servidor en puerto 9001"

    app.run(host='0.0.0.0', port=9001)

# ---------- Módulo del servidor en puerto 9002 ----------
def server_9002():
    app = Flask("server_9002")

    @app.route('/')
    def home():
        return "Servidor en puerto 9002"

    app.run(host='0.0.0.0', port=9002)

# ---------- Módulo del servidor en puerto 9003 ----------
def server_9003():
    app = Flask("server_9003")

    @app.route('/')
    def home():
        return "Servidor en puerto 9003"

    app.run(host='0.0.0.0', port=9003)

# ---------- Módulo del servidor en puerto 9004 ----------
def server_9004():
    app = Flask("server_9004")

    @app.route('/')
    def home():
        return "Servidor en puerto 9004"
